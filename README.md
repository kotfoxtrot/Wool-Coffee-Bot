# ☕️ Coffee Bot - Управление задачами

Telegram бот для управления задачами в кофейне с интеграцией Google Sheets.
...
| ФИО | Telegram Username | Должность |
|-----|-------------------|-----------|
| Седов Николай | kolya_manager | Управляющий |
| Лебедев Никита | nikita_barista | Бариста |
| Юсупова Анастасия | anastasia_barista | Бариста |
...
### 3.3 Создание листа "Оборудование"

1. Добавь еще один лист с названием **"Оборудование"**
2. Создай заголовки:
...
| Название | Периодичность | Последняя чистка | Выполнил | Статус |
|----------|---------------|------------------|----------|--------|
| Кофемолка ЕК-43S | ежедневно | 25.09.2025 | - | ⏳ |
| ЕКофемолка EК-65 | ежедневно | 20.09.2025 | - | ⏳ |
...
|-----|-----------|---|---|---|-----|-----|
| Данченко Нина | Управляющий | 08-15 | в | 08-15 | ... | 08-15 |
| Бычков Никита | Бариста | 08-15 | 08-15 | в | ... | 15-22 |
...
1. **Создай листы на год вперёд** - чтобы бот всегда находил текущий месяц
2. **Проверь часовой пояс** - должен совпадать с твоим городом
3. **Тестируй на одном сотруднике** - прежде чем добавлять всех
4. **Заполни историю чистки** - хотя бы за последнюю неделю для корректной работы
